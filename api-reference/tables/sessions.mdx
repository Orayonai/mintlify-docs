...
```bash
curl -X GET 'https://tkrjfifrwttikwsghuju.supabase.co/rest/v1/sessions?status=eq.OPEN&limit=10' \
...
```bash
curl -X PATCH 'https://tkrjfifrwttikwsghuju.supabase.co/rest/v1/sessions?id=eq.123e4567-e89b-12d3-a456-426614174000' \
  -H 'apikey: SUA_ANON_KEY' \
  -H 'Authorization: Bearer SUA_SERVICE_KEY' \
