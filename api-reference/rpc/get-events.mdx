...
openapi: 'POST /rest/v1/rpc/get_events_by_language'
...
```
POST {SUPABASE_URL}/rest/v1/rpc/get_events_by_language
```
...
<ParamField body="p_idioma" type="string">
...
```bash
curl -X POST '{SUPABASE_URL}/rest/v1/rpc/get_events_by_language' \
...
```json
{
  ...
  "method": "POST",
  "url": "{SUPABASE_URL}/rest/v1/rpc/get_events_by_language",
  "body": {}
}
```
...
2. dados_evento (segundo) ← ESTA FUNCAO
