---
title: 'Buscar Sessao'
api: 'POST /rest/v1/rpc/get_or_create_session_with_last_message'
...
```
POST https://tkrjfifrwttikwsghuju.supabase.co/rest/v1/rpc/get_or_create_session_with_last_message
```
...
```bash
curl -X POST 'https://tkrjfifrwttikwsghuju.supabase.co/rest/v1/rpc/get_or_create_session_with_last_message' \
