---
title: 'Pausar Sessao'
openapi: 'POST /rest/v1/rpc/pause_session_by_phone'
...
```
POST {SUPABASE_URL}/rest/v1/rpc/pause_session_by_phone
```
...
```bash
curl -X POST '{SUPABASE_URL}/rest/v1/rpc/pause_session_by_phone' \
...
```json
{
  ...
  "method": "POST",
  "url": "{SUPABASE_URL}/rest/v1/rpc/pause_session_by_phone",
  "body": {
