...
```
POST https://tkrjfifrwttikwsghuju.supabase.co/rest/v1/rpc/get_lead_by_phone
```
...
```bash
curl -X POST 'https://tkrjfifrwttikwsghuju.supabase.co/rest/v1/rpc/get_lead_by_phone' \
...
```json
{
  ...
  "method": "POST",
  "url": "https://tkrjfifrwttikwsghuju.supabase.co/rest/v1/rpc/get_lead_by_phone",
  "body": {
