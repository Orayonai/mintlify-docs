---
title: 'Validar Leads'
openapi: 'POST /rest/v1/rpc/get_leads_with_active_window'
...
```
POST {SUPABASE_URL}/rest/v1/rpc/get_leads_with_active_window
```
...
```bash
curl -X POST '{SUPABASE_URL}/rest/v1/rpc/get_leads_with_active_window' \
