...
<Info>
  **Requisitos:**
  ...
  - WhatsApp Business API (META) ou UAZAPI/Evolution
</Info>
...
<Frame>
  <img src="/images/n8n-config-node.png" alt="No Config no N8N" />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="UAZAPI / Evolution" icon="robot" href="/guides/n8n-agent/uazapi">
    APIs nao-oficiais. Mais flexivel, configuracao rapida.
  </Card>
</CardGroup>
